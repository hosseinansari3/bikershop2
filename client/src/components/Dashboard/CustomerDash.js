      ...
      <div className="bg-white rounded-lg w-full mb-6">
        ...
        <table className="w-full whitespace-no-wrap">
          <thead className="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b border-gray-200 dark:border-gray-700 bg-gray-100 dark:text-gray-400 dark:bg-gray-800">
            <tr>
              <td className="px-4 py-3 hidden sm:block">ID</td>
              <td className="px-4 py-3">ITEMS</td>
              <td className="px-4 py-3 hidden sm:block">DATE</td>
          ...
          <tbody className="bg-white hover:bg-gray-50 divide-y divide-gray-100 dark:divide-gray-700 dark:bg-gray-800 text-gray-700 dark:text-gray-400 dark:bg-gray-900">
            <tr>
              ...
              <td className="px-4 py-3">
                <div className="sm:w-[155px] w-[105px] overflow-x-auto flex">
                  {recentOrder?.orderItems.map((item) => {
                    return (
                      <img
        ...
        >
          {recentOrder?.orderItems.map((item) => {
            return (
              <div>
                <div className="flex mb-3 border-b-2 border-gray-200 pb-2">
                  <img
                    className="w-12 h-12 mx-0.5 border-2 border-solid object-cover rounded-sm"
                    src={item.image}
                  />
                  <div>
                    <p className=" ml-1 font-bold">{item.title}</p>
                    <div className=" justify-between ml-0 mt-2">
                      <p className="ml-5">
