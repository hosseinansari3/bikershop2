  ...
  return (
    <>
      <div
        ...
        } overlay flex fixed transition-all duration-[.5s]  z-50 justify-center items-center w-full h-full bg-gray-500/70`}
      >
        {" "}
        <div
          onClick={(e) => {
          ...
          className={` ${
            isOpen ? "open" : "close"
          } translate-y-full md:translate-y-0  z-50 fixed w-[100vw] h-[75vh]  bottom-0 md:relative px-2 pt-5 md:p-9 bg-white md:w-3/5 shadow md:h-[400px] overflow-hidden border border-gray-900 dark:border-gray-700 rounded-lg ring-1 ring-black ring-opacity-5`}
        >
          ...
          {user?.role === ROLES.Admin && (
            <div>
              <div id="status" className="flex flex-wrap justify-center mt-7">
                <input
